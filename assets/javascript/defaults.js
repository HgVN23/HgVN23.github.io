function defaults() {
	...
	script.src = "https://HgVN23.github.io/assets/javascript/sidebar.js";
	document.getElementById("script").appendChild(script);
	// ======================================================================
	// Tạo tag script filter
	var script = document.createElement('script');
	script.src = "https://HgVN23.github.io/assets/javascript/filter.js";
	document.getElementById("script").appendChild(script);
	// ======================================================================
	// Tạo tag script search
	var script = document.createElement('script');
	script.src = "https://HgVN23.github.io/assets/javascript/search.js";
	document.getElementById("script").appendChild(script);
	// ======================================================================
	// Tạo tag script và chạy dropdown
	var script = document.createElement('script');
	script.src = "https://HgVN23.github.io/assets/javascript/dropdown.js";
	document.getElementById("script").appendChild(script);
	// ======================================================================
	...
	var script = document.createElement('script');
	script.src = "https://HgVN23.github.io/assets/javascript/theme.js";
	document.getElementById("script").appendChild(script);
	// ======================================================================
	// Footer
